...
def main():
    ...
    for csv_path in csv_paths:
        ...
        if args.filtered:
            os.makedirs(os.path.join("plots", "counter_filtered"), exist_ok=True)
            os.makedirs(os.path.join("plots", "counter_outliers"), exist_ok=True)
        base = os.path.splitext(os.path.basename(csv_path))[0]
        if args.prefix:
            base = args.prefix
        hist_path = os.path.join("plots", "sec", f"{base}.png")
        seq_path = os.path.join("plots", "counter", f"{base}_seq.png")
        filtered_path = os.path.join("plots", "counter_filtered", f"{base}_seq_filtered.png")
        outliers_path = os.path.join("plots", "counter_outliers", f"{base}_seq_outliers.png")
